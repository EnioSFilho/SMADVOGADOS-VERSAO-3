...
import { ContainerMorAreas } from '../adjusts/Container.styled'
import { CardsArea } from '../adjusts/Cards.styled'
import { ButtonBlueArea } from '../buttons/Button.styled'

function MainAreas3() {
    return (
        <>
           <div className='containerMorAreas'>
